Rate = 16000;
Microphone = dsp.AudioRecorder('SampleRate',Rate,'SamplesPerFrame',3200,'DeviceName','PreSonus Studio 68','NumChannels',2);
tic;
while (toc)
    ...
    if (thre1>noise && thre2>noise)
        ...
        gcoco=((gccestimation+10)*180)/20; % Assuming 20 samples per delay value, spread to 180
